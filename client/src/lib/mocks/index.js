...
export const courses = [
  {
    id: "ee000000-0001-4000-8000-000000000001",
    slug: "land-the-remote-job",
    title: "Land the remote job",
    description: "Six modules from CV rewrite to your first week.",
    coverUrl: null,
    isPublished: true,
    accessType: "OPEN",
    requiredTierId: null,
  ...
  {
    id: "ee000000-0002-4000-8000-000000000002",
    slug: "the-interview-vault",
    title: "The interview vault",
    description: "Recorded mock interviews for 14 role types, with every answer annotated.",
    coverUrl: null,
    isPublished: true,
  ...
  {
    id: "ee000000-0003-4000-8000-000000000003",
    slug: "salary-scripts",
    title: "Salary scripts",
    description: "Word-for-word negotiation language, plus what to do when they open with a range.",
    coverUrl: null,
    isPublished: false,
    accessType: "PRIVATE_GRANT",
    requiredTierId: null,
    moduleCount: 4,
    lessonCount: 16,
    progressPercent: 0,
...
export const courseDetail = {
  ...
  modules: [
    {
      id: "ff000000-0001-4000-8000-000000000001",
      title: "Module 1 · Finding the work",
      isPublished: true,
      position: 0,
      lessons: [
        { id: "10000000-0001-4000-8000-000000000001", title: "Where the real listings live", isPublished: true, isFreePreview: true, videoDurationSeconds: 743, progress: { isCompleted: true, lastPositionSeconds: 743 } },
        { id: "10000000-0002-4000-8000-000000000002", title: "Reading a posting for intent", isPublished: true, isFreePreview: false, videoDurationSeconds: 655, progress: { isCompleted: true, lastPositionSeconds: 655 } },
      ],
    },
    {
      id: "ff000000-0002-4000-8000-000000000002",
      title: "Module 2 · Applying",
      isPublished: true,
      position: 1,
      lessons: [
        { id: "10000000-0003-4000-8000-000000000003", title: "The CV rewrite pass", isPublished: true, isFreePreview: false, videoDurationSeconds: 902, progress: { isCompleted: true, lastPositionSeconds: 902 } },
        { id: "10000000-0004-4000-8000-000000000004", title: "Writing an application that gets read", isPublished: true, isFreePreview: false, videoDurationSeconds: 1122, progress: { isCompleted: false, lastPositionSeconds: 724 } },
        { id: "10000000-0005-4000-8000-000000000005", title: "Cover notes that get opened", isPublished: true, isFreePreview: false, videoDurationSeconds: 480, progress: { isCompleted: false, lastPositionSeconds: 0 } },
      ],
    },
    {
      id: "ff000000-0003-4000-8000-000000000003",
      title: "Module 3 · Interviews",
      isPublished: true,
      position: 2,
      lessons: [
        { id: "10000000-0006-4000-8000-000000000006", title: "The screening call", isPublished: true, isFreePreview: false, videoDurationSeconds: 810, progress: { isCompleted: false, lastPositionSeconds: 0 } },
        { id: "10000000-0007-4000-8000-000000000007", title: "Take-home tasks worth doing", isPublished: false, isFreePreview: false, videoDurationSeconds: 690, progress: { isCompleted: false, lastPositionSeconds: 0 } },
      ],
    },
  ],
};
...
export const lesson = {
  id: "10000000-0004-4000-8000-000000000004",
  moduleId: "ff000000-0002-4000-8000-000000000002",
  moduleTitle: "Module 2 · Applying",
  lessonNumber: 3,
  title: "Writing an application that gets read",
  content:
    "Recruiters spend under a minute on a first pass. This lesson covers the three lines that decide whether they keep reading, and the formatting choices that make a skim work in your favour.",
  videoPlaybackId: "mock-playback-lesson-4",
  videoDurationSeconds: 1122,
  isPublished: true,
  isFreePreview: false,
  chapters: [
    { at: 0, label: "The first three lines" },
    { at: 252, label: "Proof over adjectives" },
    { at: 700, label: "Formatting for skim readers" },
    { at: 905, label: "Two rewrites, side by side" },
  ],
  attachments: [
    { name: "Application template.docx", url: "#", size: 24000, type: "docx" },
    { name: "Before / after examples.pdf", url: "#", size: 180000, type: "pdf" },
    { name: "Full transcript", url: "#", size: 12000, type: "txt" },
  ],
  progress: { isCompleted: false, lastPositionSeconds: 724 },
};
