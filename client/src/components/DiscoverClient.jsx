  ...
  return (
    <div className="max-w-[1280px] mx-auto px-6 py-12 flex flex-col md:flex-row gap-10">
      ...
      <div className="flex-1">
        <div className="mb-10">
          <h1 className="text-3xl font-extrabold text-zinc-900 tracking-tight mb-3">Explore Communities</h1>
          <p className="text-[16px] text-zinc-500 max-w-2xl">
        ...
        {paginated.length > 0 ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {paginated.map((community) => (
              <Link href={`/${community.slug}`} key={community.slug} className="group flex flex-col bg-white rounded-xl border border-zinc-200 overflow-hidden hover:shadow-lg hover:border-zinc-300 transition-all duration-300">
                <div className="h-[160px] w-full relative bg-zinc-100 overflow-hidden">
                  ...
                  <div className="absolute top-3 right-3 bg-white/90 backdrop-blur-sm px-2.5 py-1 rounded-md text-[12px] font-bold text-zinc-900 shadow-sm">
                    {community.price}
                  </div>
                </div>
                <div className="p-5 flex flex-col flex-1">
                  <div className="flex items-start gap-3 mb-3">
                    <img src={community.icon} alt="" className="w-10 h-10 rounded-lg object-cover border border-zinc-100 shrink-0" />
                    <h3 className="font-bold text-[15.5px] text-zinc-900 leading-tight group-hover:text-blue-600 transition-colors">{community.title}</h3>
                  </div>
                  <p className="text-[13.5px] text-zinc-500 line-clamp-2 leading-relaxed mb-4">
                    {community.desc}
                  </p>
                  <div className="mt-auto flex items-center gap-2 text-[13px] text-zinc-500 font-medium pt-4 border-t border-zinc-100">
          ...
          <div className="text-center py-20 text-zinc-500 bg-white border border-dashed border-zinc-300 rounded-xl">
        ...
        {totalPages > 1 && (
          <div className="mt-12 flex items-center justify-center gap-2">
            <button 
              ...
              className="px-3 py-1.5 rounded-md text-[14px] font-medium text-zinc-600 hover:bg-zinc-100 disabled:opacity-40 disabled:hover:bg-transparent transition-colors"
              suppressHydrationWarning
            >
              Previous
            </button>
